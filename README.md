...
Using [`process_video.py`](process_video.py), we can perform the above detection on all frames of a video.  It has a function process_video_frame() which is invoked on each frame.  A variable *consecutive_appearance*
